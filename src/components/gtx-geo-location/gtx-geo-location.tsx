  ...
  showError() {
    ...
    return (
      <div class="geo-location__error-wrapper">
        ...
        <div>
          Se ha producido un error al obtener los datos de localización.
        </div>
      </div>
    );
  }
  ...
  showFooter() {
    return (
      <div class="geo-location__footer">
        Iconos de <a href="https://freeicons.io/profile/730" target="_blank">
          Anu Rocks
        </a>, <a href="https://freeicons.io/profile/3" target="_blank">
          icon king1
        </a> y <a href="https://freeicons.io/profile/714" target="_blank">
          Raj Dev
        </a> desde <a href="https://freeicons.io" target="_blank">freeicons.io</a>
      </div>
    );
  }
